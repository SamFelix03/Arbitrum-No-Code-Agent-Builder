        ...
        <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-[#1E3A8A] to-[#60A5FA] text-transparent bg-clip-text block md:inline">My Agents</span>
            </h1>
            <p className="text-muted-foreground mt-2">
              Manage and interact with your Arbitrum agents
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Create your first Arbitrum agent to get started with workflow automation
            </p>
